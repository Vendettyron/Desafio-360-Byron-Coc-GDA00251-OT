...
export function LoginForm({ className, ...props }) {
    ...
    const handleClick = () => {
        window.open('https://github.com/Vendettyron/Desafio-360-Byron-Coc-GDA00251-OT', '_blank', 'noopener,noreferrer');
      };
    ...
    return (
        <>
            <form className={cn("flex flex-col gap-6 shadow-lg bg-slate-200 p-5 rounded-lg", className)} {...props} onSubmit={handleSubmit(onSubmit)} noValidate>
                ...
                <div className="grid gap-6">
                    <div className="grid gap-2">
                        ...
                        <Input id="correo" type="email" placeholder="m@example.com" required {...register('correo')} />
                    </div>
                    <div className="grid gap-2">
                    ...
                    <Button variant="outline" className="w-full bg-slate-300" onClick={handleClick} >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  className="inline-block w-6 h-6 mr-2 ">
                            <path
